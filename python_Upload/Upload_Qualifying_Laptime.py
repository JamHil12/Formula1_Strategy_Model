###### Upload_Qualifying_Laptime.py
# Uploads qualifying time data into BigQuery, downloading from the Ergast API
...
def upload_qualifying_laptime(year,round_start,round_end):
